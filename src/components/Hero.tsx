  ...
  return (
    <section id="statue" class="relative min-h-[85vh] flex flex-col md:flex-row items-center justify-between px-6 lg:px-12 py-12 max-w-7xl mx-auto gap-12 border-b border-white/5">
      ...
      <div class="w-full md:w-1/2 space-y-6 z-10 text-center md:text-left">
        <div class="inline-block px-4 py-1.5 border border-[#d3122a]/40 bg-[#d3122a]/10 rounded-full">
          <span class="text-[10px] font-bold text-[#d3122a] uppercase tracking-[0.2em] flex items-center gap-2">
        ...
        <h1 class="text-6xl sm:text-7xl lg:text-9xl font-black tracking-tighter uppercase leading-[0.85] font-brand italic">
          VIRAT<br />
          <span class="text-[#d3122a] not-italic">KOHLI</span>
        </h1>

        <div class="flex gap-6 items-start justify-center md:justify-start pt-2">
          <div class="w-1.5 bg-[#d3122a] h-24 shrink-0 hidden sm:block"></div>
          <p class="text-white/70 text-base sm:text-lg max-w-xl leading-relaxed font-light text-left">
            A relentless force of nature in RCB Red and Team India Blue. From a determined boy in Delhi to the{' '}
            <span class="text-white font-medium">prolific record-breaker</span> with <span class="text-[#d3122a] font-bold">9,336 IPL runs</span> for RCB, 54 ODI centuries & 85 international hundreds.
          </p>
        </div>
        ...
        <div class="flex flex-wrap gap-4 justify-center md:justify-start pt-4">
          <a
            href="#timeline"
            class="px-8 py-4 bg-[#d3122a] text-white text-[12px] font-black uppercase tracking-widest hover:bg-white hover:text-black transition-all transform hover:scale-105 flex items-center gap-2 cursor-pointer shadow-lg shadow-[#d3122a]/30"
          >
        ...
        <div class="pt-6 border-t border-white/10 flex items-center gap-4 bg-[#0a0c12] p-4 border border-[#d3122a]/30 max-w-lg">
          <img
            src={worldCupTrophyImg}
            alt="2011 ICC Cricket World Cup Champion Trophy"
            class="w-16 h-16 object-contain shrink-0 filter drop-shadow-md"
            referrerPolicy="no-referrer"
          />
          <div class="text-left">
            <span class="text-[9px] uppercase tracking-[0.25em] font-bold text-[#d3122a] block">
              Pinnacle Legacy
            </span>
            <h4 class="text-sm font-black text-amber-400 uppercase tracking-wide font-brand mt-0.5">
              2011 ICC Cricket World Cup Champion
            </h4>
            <p class="text-[10px] text-white/50 font-mono mt-0.5">
